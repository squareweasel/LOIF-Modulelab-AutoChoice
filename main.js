...
(function(storyContent) {
    ...
    function continueStory(firstTime) {
        ...
        function autoPlay () {
            console.log("Autoplaying: " + userDreams + " times.");
            // for (var i=0;i<2;i++)
            // {
            //     console.log(i);
            // }
            ...
            {   
                console.log(i);
                while (story.currentChoices[0].text=="continue")
                    { 
                ...
                if (story.currentChoices[0].text=="Restart.")
                {
                    story.ChooseChoiceIndex(0);
                        removeAll(".choice");
                        continueStory();

                        console.log("Loops Remaining: " + userDreams);
                }
            }
